...
```
  Observation: The Starbucks franchise has locations around the world, but mostly in the United States and Eastern Europe. The majority of the companies appear to be company owned as there are only one type of color that is visible on the map.
...
starbucks_with_2018_pop_est %>% 
  ...
  labs(title = "Starbucks in the United States per 10000",
...
Kal_Places <- tribble(
  ...
  "Macalester College", 44.93818,  -93.17073, FALSE,
  "Snap Fitness", 44.94397,  -93.16755, FALSE,
  "Home (MN)", 44.93102, -93.17147, TRUE,
  "Home (MA)", 42.37047, -72.10636, FALSE,
  "Princeton", 33.1856, -96.5061, FALSE,
  "Boston", 42.3773, -71.0903, FALSE,
  "White Mountains", 44.16128, -71.64579, FALSE,
  "Acadia National Park", 44.4147, -68.4270, TRUE,
  "Plums", 44.92784, -93.16834, FALSE,
  "Grandparent's House", 44.5454, -67.8753, TRUE)
